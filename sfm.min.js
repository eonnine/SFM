...
"file_extension")),!1;for(a=0;c=g[a];a++)if(b===c)return alert(this.getConfig("message","file_extension_except")),!1;return!0};d.prototype.createNewFile=function(a,b){try{var c=new Blob([a],{type:a.type})}catch(g){c=a}c.name=b;c.lastModified=a.lastModified||0;c.lastModifiedDate=a.lastModifiedDate||0;return c};d.prototype.makeItemKey=function(a){for(var b=a,c=1,g;this.fileMap.isContainsKey(b);)c++,g=a.substring(a.lastIndexOf("."),a.length),b=a.substring(0,a.lastIndexOf(".")),b=b+" ("+c+")"+g;return b};
